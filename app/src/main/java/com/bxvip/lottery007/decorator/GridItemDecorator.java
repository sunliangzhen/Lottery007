package com.bxvip.lottery007.decorator;
...
public class GridItemDecorator extends RecyclerView.ItemDecoration {
    ...
    public GridItemDecorator(int space, int color) {
        this.mSpace = space;
        this.mColor = color;
    ...
    public GridItemDecorator(int space, int color, int type) {
        this.mSpace = space;
        this.mColor = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public GridItemDecorator(int space, Drawable mDivider) {
        this.mSpace = space;
