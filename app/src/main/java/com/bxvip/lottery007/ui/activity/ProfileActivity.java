...
public class ProfileActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_qqlogin = (LinearLayout) findViewById(R.id.ll_qqlogin);
        rl_profile_clearcache = (RelativeLayout) findViewById(R.id.rl_profile_clearcache);
        rl_profile_checkupdate = (RelativeLayout) findViewById(R.id.rl_profile_checkupdate);
        rl_profile_feedback = (RelativeLayout) findViewById(R.id.rl_profile_feedback);
        rl_profile_share = (RelativeLayout) findViewById(R.id.rl_profile_share);
        rl_profile_pushmsg = (RelativeLayout) findViewById(R.id.rl_profile_pushmsg);
        rl_profile_exit = (RelativeLayout) findViewById(R.id.rl_profile_exit);
