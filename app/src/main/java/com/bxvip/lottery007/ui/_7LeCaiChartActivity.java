...
@ContentView(R.layout.activity_7lecai_chart)
public class _7LeCaiChartActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_7lecai_chart);
...
//        barchart.getAxisRight().setEnabled(false);
        ...
        barEntries2.add(new BarEntry(800, n8));
        List<BarEntry> barEntries3 = new ArrayList<>();
        if (type == 1) {
            barEntries3.add(new BarEntry(900, n1+n2+n3+n4+n5+n6+n7));
        } else if (type == 2) {
            barEntries3.add(new BarEntry(900, (n1+n2+n3+n4+n5+n6+n7)/ 7));
        } else if (type == 3) {
            if (n7 > n4) {
                barEntries3.add(new BarEntry(900, n4));
            } else if (n7 < n3){
                barEntries3.add(new BarEntry(900, n3));
            } else {
                barEntries3.add(new BarEntry(900, n7));
            }
        } else if (type == 4) {
            int left = n6;
            int right = n7;
            if (right <= left) {
                barEntries3.add(new BarEntry(900, n6-n1));
            } else {
                barEntries3.add(new BarEntry(900, n7-n1));
            }
        } else if (type == 5) {
            ...
            barEntries3.add(new BarEntry(900, (float) result));
        }
        BarDataSet dataSet1 = new BarDataSet(barEntries1, "红球");
        dataSet1.setColor(getResources().getColor(R.color.orange_red));
        BarDataSet dataSet2 = new BarDataSet(barEntries2, "蓝球");
        dataSet2.setColor(getResources().getColor(R.color.sky_blue));
