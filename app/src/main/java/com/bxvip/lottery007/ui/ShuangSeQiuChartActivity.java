...
@ContentView(R.layout.activity_shuangseqiu_chart)
public class ShuangSeQiuChartActivity extends BaseAppCompatActivity {
...
//        barchart.getAxisRight().setEnabled(false);
        ...
        barEntries2.add(new BarEntry(700, n7));
        ...
        if (type == 1) {
            ...
            if (n7 > n4) {
                barEntries3.add(new BarEntry(800, n4));
            } else if (n7 < n3){
                barEntries3.add(new BarEntry(800, n3));
            } else {
                barEntries3.add(new BarEntry(800, n7));
            }
        } else if (type == 4) {
            int left = n6;
            int right = n7;
            if (right <= left) {
                barEntries3.add(new BarEntry(800, n6-n1));
            } else {
                barEntries3.add(new BarEntry(800, n7-n1));
            }
        } else if (type == 5) {
