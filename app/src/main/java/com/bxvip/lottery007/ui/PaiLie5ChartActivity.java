...
@ContentView(R.layout.activity_pailie5_chart)
public class PaiLie5ChartActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pailie5_chart);
...
//        barchart.getAxisRight().setEnabled(false);
        ...
        if (type == 1) {
            barEntries3.add(new BarEntry(600, n1+n2+n3+n4+n5));
        } else if (type == 2) {
            barEntries3.add(new BarEntry(600, (n1+n2+n3+n4+n5)/ 5));
        } else if (type == 3) {
            barEntries3.add(new BarEntry(600, sortList.get(2)));
        } else if (type == 4) {
            barEntries3.add(new BarEntry(600, sortList.get(4) - sortList.get(0)));
        } else if (type == 5) {
            int avg = (n1+n2+n3+n4+n5)/ 5;
            double result = Math.sqrt(((double)(n1-avg)*(n1-avg)+(n2-avg)*(n2-avg)+(n3-avg)*(n3-avg)+(n4-avg)*(n4-avg)+(n5-avg)*(n5-avg))/ 5);
            barEntries3.add(new BarEntry(600, (float) result));
        }
