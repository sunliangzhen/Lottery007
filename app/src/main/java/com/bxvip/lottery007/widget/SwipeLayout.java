...
public class SwipeLayout extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        timer = new MyTimer(updateHandler);//循环UI检查
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateImageView.setImageResource(R.drawable.icon_swipe_layout_refresh_succeed);
                break;
            case FAIL:
            default:
                // 刷新失败
                refreshStateTextView.setText(R.string.refresh_fail);
                refreshStateImageView.setImageResource(R.drawable.icon_swipe_layout_refresh_failed);
                break;
        }
        if (pullDownY > 0) {
            // 刷新结果停留1秒
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateImageView.setImageResource(R.drawable.icon_swipe_layout_load_succeed);
                break;
            case FAIL:
            default:
                // 加载失败
                loadStateTextView.setText(R.string.load_fail);
                loadStateImageView.setImageResource(R.drawable.icon_swipe_layout_load_failed);
                break;
        }
        if (pullUpY < 0) {
            // 刷新结果停留1秒
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            case INIT:
                // 下拉布局初始状态
                refreshStateImageView.setImageResource(R.drawable.icon_swipe_layout_logo);
                refreshStateTextView.setText(R.string.pull_to_refresh);
                // 上拉布局初始状态
                loadStateImageView.setImageResource(R.drawable.icon_swipe_layout_logo);
            ...
            case REFRESHING:
                ...
                refreshStateImageView.setImageResource(R.drawable.icon_swipe_layout_refreshing);
            ...
            case LOADING:
                ...
                loadStateImageView.setImageResource(R.drawable.icon_swipe_layout_loading);
